...
class AddAddress extends StatefulWidget {
  ...
  AddAddress({this.addAddressType = AddAddressType.OTHER});
  @override
  _AddAddressState createState() => _AddAddressState();
}

enum AddAddressType { FROM_SIGN_UP, OTHER }
                                    ...
                                    if (_formKey.currentState.validate()) {
                                      ...
                                      AddressRepository()
                                        ...
                                        if (value.result) {
                                          ...
                                          ///FIXME:
                                          ///on click we need to go home if this user is coming from signup page.
                                          if (widget.addAddressType ==
                                              AddAddressType.FROM_SIGN_UP) {
