import 'package:denta_needs/Apis/review_repositories.dart';
                        ...
                        return FlatButton(
                          child: Text(
                            !controller.expanded
                                ...
                                : getLang(context, "Show_Less Less"),
    ...
    return Container(
      ...
      child: Center(
        child: Text(_totalData == _reviewList.length
            ? getLang(context, "No More Reviews")
            : getLang(context, "Loading More Reviews ...")),
      ),
    );
  }
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    ...
                    hintText: getLang(context, "Type your review here ..."),
                    hintStyle: TextStyle(fontSize: 14.0, color: fontColor),
                    enabledBorder: OutlineInputBorder(
                      borderSide: BorderSide(color: fontColor, width: 0.5),
