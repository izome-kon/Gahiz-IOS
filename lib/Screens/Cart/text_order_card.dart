...
class TextOrderCard extends StatefulWidget {
  final bool payment;
  final CartItem cartItem;
  final row, col; //supplier index , product index

  TextOrderCard({this.payment = false, this.cartItem, this.col, this.row});

  @override
  _ProductCartCardState createState() => _ProductCartCardState();
}

class _ProductCartCardState extends State<TextOrderCard> {
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => TackTextScreen(
