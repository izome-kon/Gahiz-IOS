...
class CartRepository {
  ...
  Future<CartDeleteResponse> getCartDeleteAllResponse(cart_id) async {
    final response = await http.get(
      Uri.parse("${AppConfig.BASE_URL}/carts/deleteAll/$cart_id"),
      headers: {
        "Content-Type": "application/json",
        "Authorization": "Bearer ${access_token.$}"
      },
  ...
  Future<CartProcessResponse> getCartProcessResponse(
    ...
    try {
      final response = await http.post(
          Uri.parse("${AppConfig.BASE_URL}/carts/process"),
          headers: {
            "Content-Type": "application/json",
            "Authorization": "Bearer ${access_token.$}"
          },
  ...
  Future<CartAddResponse> getCartAddResponse(
    ...
    final response = await http.post(
        Uri.parse("${AppConfig.BASE_URL}/carts/add"),
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer ${access_token.$}"
        },
  ...
  Future<void> getCartAddCollectionResponse(
    ...
    final response = await http.post(
        Uri.parse("${AppConfig.BASE_URL}/carts/add-sum-products"),
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer ${access_token.$}"
        },
  ...
  Future<CartAddResponse> getCartAddVoiceRecordResponse({
    ...
    final response = await http.post(
        Uri.parse("${AppConfig.BASE_URL}/carts/addVoiceRecord"),
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer ${access_token.$}"
        },
