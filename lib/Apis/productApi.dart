...
class ProductApi {
  ...
  Future<ProductMiniResponse> getShopProducts(
      {int id = 0, name = "", page = 1}) async {
    var url = Uri.parse("${AppConfig.BASE_URL}/products/seller/" +
        id.toString() +
        "?page=$page&name=$name");
  ...
  Future<ProductMiniResponse> getShopProductsByCategories(
    ...
    print('Shop id -> ' + id.toString());
    var url = Uri.parse("${AppConfig.BASE_URL}/categories/shop/products/" +
        id.toString() +
        "?page=${page}&name=${name}");
  ...
  Future<ProductMiniResponse> getFilteredProducts(
      ...
      min = "",
      max = ""}) async {
    var url = Uri.parse("${AppConfig.BASE_URL}/products/search" +
